...
def compute_distances_no_loops(x_train, x_test):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  # 참고 https://stackoverflow.com/questions/27948363/numpy-broadcast-to-perform-euclidean-distance-vectorized
...
def knn_cross_validate(x_train, y_train, num_folds=5, k_choices=None):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  x_train_folds = torch.chunk(x_train, num_folds, dim=0) #chunk : 쪼개기 
  ...
  for k in k_choices:
    ...
    for num_fold in range(num_folds):
      ...
      x_test = x_train_folds_local[num_fold] #validation set
      y_test = y_train_folds_local[num_fold] #validation set
...
def knn_get_best_k(k_to_accuracies):
  ...
  best_k = [k for k,v in new_dict.items() if v==max_values][0]
